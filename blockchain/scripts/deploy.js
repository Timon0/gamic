...
async function main() {
  ...
  const createLicenceTx1 = await gamic.mintLicence("MyGame_1", "Deploy", 100000000000000);
  await createLicenceTx1.wait();
  const createLicenceTx2 = await gamic.mintLicence("MyGame_2", "Deploy", 100000000000000);
